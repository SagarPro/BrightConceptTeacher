...
public class LkgFrag extends BrowseFragment {
    ...
    public static LkgFrag mainFrag;
    ...
    private void setupEventListeners() {
        ...
        setOnItemViewSelectedListener(new LkgFrag.ItemViewSelectedListener());
    }
    ...
    private void startBackgroundTimer() {
        ...
        mBackgroundTimer.schedule(new LkgFrag.UpdateBackgroundTask(), BACKGROUND_UPDATE_DELAY);
    }
