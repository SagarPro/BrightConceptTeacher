...
import sagu.supro.BCT.levels.playgroup.PlaygroupFrag;
...
public class NurseryFrag extends BrowseFragment {
    ...
    private void setupEventListeners() {
        ...
        setOnItemViewSelectedListener(new NurseryFrag.ItemViewSelectedListener());
    }
    ...
    private void startBackgroundTimer() {
        ...
        mBackgroundTimer.schedule(new NurseryFrag.UpdateBackgroundTask(), BACKGROUND_UPDATE_DELAY);
    }
